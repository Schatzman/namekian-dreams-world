...
4. Daylight/F3 light check: at noon (`/time set noon`), stand outdoors in the Namekian overworld and check F3 sky light. Expected gameplay sky light is `10` where vanilla would show `15`; intermediate sky light subtracts five and clamps to `0..10`.
